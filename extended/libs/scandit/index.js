...
(function (global, factory) {
  ...
  var _bind = Function.bind || function bind(that /* , ...args */) {
    ...
    var bound = function (/* args... */) {
      ...
      return this instanceof bound ? construct$2(fn, args.length, args) : _invoke(fn, args, that);
    };
  ...
  (function (BrowserHelper) {
    ...
    function getDeviceId() {
      ...
      deviceId = from(randomDeviceIdBytes).map(function (byteNumber) {
  ...
  function engine() {
      ...
      Module = {
        ...
        instantiateWasm: function instantiateWasm(importObject, successCallback) {
          ...
          if (wasmJSVersion !== "5.6.0") {
            console.error("The Scandit SDK Engine library JS file found at ".concat(jsURI, " seems invalid: ") + "expected version doesn't match (received: ".concat(wasmJSVersion, ", expected: ", "5.6.0", "). ") + "Please ensure the correct Scandit SDK Engine file (with correct version) is retrieved.");
          }
    ...
    function getLibraryLocationURIs(libraryLocation) {
      ...
      return {
        jsURI: "".concat(libraryLocation, "scandit-engine-sdk.min.js?v=5.6.0"),
        wasmURI: "".concat(libraryLocation, "scandit-engine-sdk.wasm?v=5.6.0")
      };
    }
        ...
        if (typeof ((_crypto = crypto) === null || _crypto === void 0 ? void 0 : (_crypto$subtle = _crypto.subtle) === null || _crypto$subtle === void 0 ? void 0 : _crypto$subtle.digest) === "function") {
          crypto.subtle.digest("SHA-256", responseData).then(function (hash) {
            ...
            if (hashString !== "cbda3ec8ee7bfb9f57b0a8c9977e5e06734a551978620a0852aba6abbb9525b1") {
              console.error("The Scandit SDK Engine library WASM file found at ".concat(wasmURI, " seems invalid: ") + "expected file hash doesn't match (received: ".concat(hashString, ", ") + "expected: ".concat("cbda3ec8ee7bfb9f57b0a8c9977e5e06734a551978620a0852aba6abbb9525b1", "). ") + "Please ensure the correct Scandit SDK Engine file (with correct version) is retrieved.");
            }
          }).catch(
          /* istanbul ignore next */
          function () {// Ignored
  ...
  var EngineLoader = /*#__PURE__*/function () {
    function EngineLoader(preload) {
      _classCallCheck(this, EngineLoader);
  ...
  var BlurryRecognitionPreloader = /*#__PURE__*/function () {
    function BlurryRecognitionPreloader(preload) {
      ...
      this.queuedBlurryRecognitionSymbologies = from(BlurryRecognitionPreloader.availableBlurryRecognitionSymbologies.values());
    ...
    _createClass(BlurryRecognitionPreloader, [{
      ...
      value: function getEnabledSymbologies(scanSettings) {
        return from(BlurryRecognitionPreloader.availableBlurryRecognitionSymbologies.values()).filter(function (symbology) {
    ...
    _createClass(SymbologySettings, [{
      ...
      value: function enableExtensions(extension) {
        ...
        if (typeof extension === "object") {
          this.extensions = new set([].concat(_toConsumableArray(this.extensions), _toConsumableArray(from(extension).filter(function (e) {
      ...
      value: function enableChecksums(checksum) {
        ...
        if (typeof checksum === "object") {
          this.checksums = new set([].concat(_toConsumableArray(this.checksums), _toConsumableArray(from(checksum).filter(function (c) {
      ...
      value: function toJSON() {
        return {
          ...
          extensions: from(this.extensions),
          checksums: from(this.checksums)
        };
      }
    }, {
  ...
  (function (SymbologySettings) {
     ...
     */
    function getNumberRange(from$1, to) {
      return from({
        length: to - from$1 + 1
      }, function (_, k) {
        return k + from$1;
  ...
  function _createForOfIteratorHelper(o, allowArrayLike) { var it; if (typeof symbol === "undefined" || o[iterator] == null) { if (Array.isArray(o) || (it = _unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = getIterator(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it.return != null) it.return(); } finally { if (didErr) throw err; } } }; }

  function _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }
  ...
  var CameraManager = /*#__PURE__*/function () {
    ...
    _createClass(CameraManager, [{
      ...
      value: function () {
        var _reinitializeCamera = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee5() {
      ...
      value: function () {
        var _initializeCameraWithSettings = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee6(camera, cameraSettings) {
      ...
      key: "setTorchEnabled",
      value: function () {
        var _setTorchEnabled = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee7(enabled) {
      ...
      key: "toggleTorch",
      value: function () {
        var _toggleTorch = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee8() {
      ...
      key: "setZoom",
      value: function () {
        var _setZoom = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee9(zoomPercentage, currentZoom) {
      ...
      value: function () {
        var _recoverStreamIfNeeded = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee10() {
      ...
      value: function () {
        var _setupCamerasAndStream = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee11() {
      ...
      value: function () {
        var _accessAutoselectedCamera = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee12(cameras) {
      ...
      value: function () {
        var _accessInitialCamera = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee13() {
          var initialCamera;
      ...
      value: function () {
        var _videoTrackEndedRecovery = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee14() {
      ...
      value: function () {
        var _videoTrackMuteRecovery = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee15() {
      ...
      value: function () {
        var _triggerManualFocusForContinuous = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee18() {
          var _this3 = this;
          ...
          return regenerator.wrap(function _callee18$(_context18) {
            while (1) {
              switch (_context18.prev = _context18.next) {
                case 0:
                  this.manualToAutofocusResumeTimeout = window.setTimeout( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee16() {
                ...
                case 3:
                  this.manualFocusWaitTimeout = window.setTimeout( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee17() {
      ...
      value: function () {
        var _triggerManualFocusForSingleShot = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee19() {
          var _this4 = this;
      ...
      value: function () {
        var _triggerManualFocus = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee20(event) {
      ...
      key: "triggerZoomMove",
      value: function () {
        var _triggerZoomMove = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee21(event) {
      ...
      value: function () {
        var _triggerAutoFocus = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee22() {
      ...
      value: function () {
        var _triggerFocusMode = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee23(focusMode) {
          var videoTracks;
      ...
      value: function () {
        var _initializeCameraAndCheckUpdatedSettings = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee24(camera) {
          var _this7 = this;
      ...
      value: function () {
        var _handleCameraInitializationError = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee25(camera, cameraResolutionConstraint, error) {
      ...
      value: function () {
        var _initializeCamera = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee26(camera, cameraResolutionConstraint) {
      ...
      value: function () {
        var _checkCameraAccess = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee27(camera) {
          var _this9 = this;
          ...
          return regenerator.wrap(function _callee27$(_context27) {
            while (1) {
              switch (_context27.prev = _context27.next) {
                case 0:
                  window.clearTimeout(this.cameraAccessTimeout);
                  return _context27.abrupt("return", new promise(function (_, reject) {
      ...
      value: function () {
        var _checkVideoMetadata = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee28(camera) {
          var _this10 = this;
  ...
  var DummyCameraManager = /*#__PURE__*/function (_CameraManager) {
    ...
    _createClass(DummyCameraManager, [{
      ...
      key: "applyCameraSettings",
      value: function () {
        var _applyCameraSettings = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee4(_1) {
          return regenerator.wrap(function _callee4$(_context4) {
            while (1) {
              switch (_context4.prev = _context4.next) {
                case 0:
      ...
      key: "initializeCameraWithSettings",
      value: function () {
        var _initializeCameraWithSettings = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee6(_1, _2) {
          return regenerator.wrap(function _callee6$(_context6) {
            while (1) {
              switch (_context6.prev = _context6.next) {
                case 0:
      ...
      key: "setTorchEnabled",
      value: function () {
        var _setTorchEnabled = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee7(_1) {
          return regenerator.wrap(function _callee7$(_context7) {
            while (1) {
              switch (_context7.prev = _context7.next) {
                case 0:
      ...
      key: "setZoom",
      value: function () {
        var _setZoom = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee9(_1, _2) {
          return regenerator.wrap(function _callee9$(_context9) {
            while (1) {
              switch (_context9.prev = _context9.next) {
                case 0:
  ...
  var LazyAttributeConverter = /*#__PURE__*/function () {
    ...
    _createClass(LazyAttributeConverter, [{
      ...
      key: Attribute.CONFIGURE_HIGH_QUALITY_BLURRY_RECOGNITION,
      get: function get() {
  ...
  ***************************************************************************** */
  ...
  var Controller = /*#__PURE__*/function () {
    function Controller(view) {
      ...
      this.allSymbologies = values(exports.Barcode.Symbology).filter(function (s) {
    ...
    _createClass(Controller, [{
      ...
      value: function validateAllAttributes() {
        ...
        var attrs = from(this.view.getAttributes());
  ...
  var ScanditBarcodePicker = /*#__PURE__*/function (_HTMLElement) {
    ...
    _createClass(ScanditBarcodePicker, [{
      ...
      value: function getAttributes() {
        return from(this.attributes).map(function (att) {
          return {
            name: att.name,
            value: att.value
          };
